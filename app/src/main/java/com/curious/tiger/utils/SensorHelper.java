 ...
 * <p/>
 * This class is a piece of android.hardware.Sensor
 * which will convert the integer type to readable type.
 */
...
public class SensorHelper {
    ...
    public static String getStringType(int value) {
        String mStringType;
        switch (value) {
            ...
            case TYPE_TEMPERATURE:
                ...
                break;
            default:
                mStringType = String.valueOf(value);
        }
